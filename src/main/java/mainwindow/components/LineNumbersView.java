...
public class LineNumbersView extends JComponent implements DocumentListener, CaretListener, ComponentListener {
    ...
    public void paintComponent(Graphics g) {
      ...
      //int startOffset = (int) getDistanceFromTwoPoints( editor.getLocation(), new Point(0, clip.y));
      //int endOffset = (int) getDistanceFromTwoPoints( editor.getLocation(), new Point(0, clip.y + clip.height));
